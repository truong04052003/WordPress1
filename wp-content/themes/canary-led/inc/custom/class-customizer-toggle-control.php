<?php
class Canary_Led_Control_Toggle extends \WP_Customize_Control {
	public $type = 'ios';
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'canary-led-customizer-toggle-control', get_template_directory_uri() . '/inc/custom/js/customizer-toggle-control.js', array( 'jquery' ), false, true );
		wp_enqueue_style( 'canary-led-pure-css-toggle-buttons', get_template_directory_uri() . '/inc/custom/pure-css-toggle-buttons/pure-css-togle-buttons.css', null );

		$css = '
			.disabcanary-led-control-title {
				color: #a0a5aa;
			}
