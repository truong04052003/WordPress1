...
if ( ! class_exists( 'Canary_Led_Control_Radio_Image' ) ){
    
    /**
	 * Radio Image control (modified radio).
    */
	class Canary_Led_Control_Radio_Image extends WP_Customize_Control{
        ...
        public function enqueue() {
            wp_enqueue_style( 'canary-led-radio-image-style', get_template_directory_uri() . '/inc/custom/radio-image/radioimage.css', null );
            wp_enqueue_script( 'canary-led-radio-image-script', get_template_directory_uri() . '/inc/custom/radio-image/radioimage.js', array( 'jquery' ), false, true );
        }
